...
<body>
                ...
                <div class="ht-right">
                    ...
                    <div class="lan-selector">
                        <select class="language_drop" name="countries" id="countries">
                            <option value='yt' data-image="{{asset('landing/img/flag-1.jpg')}}" data-imagecss="flag yt"
                                data-title="English">English</option>
                            <option value='yu' data-image="{{asset('landing/img/flag-2.jpg')}}" data-imagecss="flag yu"
                                ...
                                <div class="cart-hover">
                                    <div class="select-items">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="si-pic"><img src="{{asset('landing/img/select-product-1.jpg')}}" alt=""></td>
                                                    <td class="si-text">
                                                ...
                                                <tr>
                                                    <td class="si-pic"><img src="{{asset('landing/img/select-product-2.jpg')}}" alt=""></td>
                                                    <td class="si-text">
                                                        <div class="product-selected">
                                                            <p>$60.00 x 1</p>
                                                            <h6>Kabino Bedside Table</h6>
    ...
    <div class="banner-section spad">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="{{asset('landing/img/banner-3.jpg')}}" alt="">
                        <div class="inner-text">
                            <h4>Kid’s</h4>
                        </div>
                    </div>
    ...
    <section class="women-banner spad">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    <div class="product-large set-bg" data-setbg="{{asset('landing/img/products/women-large.jpg')}}">
                        <h2>Women’s</h2>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('landing/img/products/man-1.jpg')}}" alt="">
                                <div class="sale">Sale</div>
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('landing/img/products/man-2.jpg')}}" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('landing/img/products/man-3.jpg')}}" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('landing/img/products/man-4.jpg')}}" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="product-large set-bg m-large" data-setbg="{{asset('landing/img/products/man-large.jpg')}}">
                        <h2>Men’s</h2>
                        <a href="#">Discover More</a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            <div class="sb-icon">
                                <img src="{{asset('landing/img/icon-1.png')}}" alt="">
                            </div>
                            <div class="sb-text">
                                <h6>Free Shipping</h6>
                    ...
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            <div class="sb-icon">
                                <img src="{{asset('landing/img/icon-2.png')}}" alt="">
                            </div>
                            <div class="sb-text">
            ...
            <div class="logo-carousel owl-carousel">
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="{{asset('landing/img/logo-carousel/logo-1.png')}}" alt="">
                    </div>
                </div>
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="{{asset('landing/img/logo-carousel/logo-2.png')}}" alt="">
                    </div>
                </div>
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="{{asset('landing/img/logo-carousel/logo-3.png')}}" alt="">
                    </div>
                </div>
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="{{asset('landing/img/logo-carousel/logo-4.png')}}" alt="">
                    </div>
                </div>
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="{{asset('landing/img/logo-carousel/logo-5.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
